...
export default class VeryAxios {
  constructor (options = {}, axiosConfig = {}) {
    ...
    this.duplicatedKeyFn = isFunction(duplicatedKeyFn)
      ? duplicatedKeyFn
  ...
  interceptors () {
    ...
    this.axios.interceptors.response.use(
      ...
      (res) => {
        ...
        const {
          config: { veryConfig: { disableHooks, disableTip, getResData: resolveResData } = {} }
        } = res;
        ...
        return new Promise((resolve, reject) => {
          ...
          const data = isFunction(resolveResData)
            ? resolveResData(resData)
  ...
  FORMDATA (path, params, config = {}) {
    ...
    return new Promise((resolve, reject) => {
      const _config = merge(defaultFormDataConfig, config);
      this.axios({ url: path, ..._config })
        .then((response) => resolve(response))
        .catch((err) => reject(err));
    });
  }
